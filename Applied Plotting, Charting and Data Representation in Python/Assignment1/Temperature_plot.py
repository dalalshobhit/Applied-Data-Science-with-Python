...
minimum_temp_outlier = np.where(result_mintemp['Temp_deg_Cel_15']<result_mintemp['Temp_deg_Cel'])[0]
maximum_temp_outlier = np.where(result_maxtemp['Temp_deg_Cel_15']>result_maxtemp['Temp_deg_Cel'])[0]
